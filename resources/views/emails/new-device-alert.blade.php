...
<table>
    <tr>
        <td align="center">
            ...
            <a href="{{ $blockUrl ?? '' }}" class="button button-{{ $color ?? 'primary' }}" target="_blank" rel="noopener">Block Device</a>
            @endif
        </td>
        <td width="75%">
            ...
            <b>@lang('auth-logger::messages.platform'):</b> {{ $platform }} ({{ $platformVersion }}) <br>
            @if($deviceName)
